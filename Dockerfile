...
RUN useradd -d /DAC -u 13071 DAC
USER DAC

RUN mkdir -p /DAC/.mujoco \
    && wget https://www.roboti.us/download/mjpro150_linux.zip -O mujoco.zip \
    && unzip mujoco.zip -d /DAC/.mujoco \
    && rm mujoco.zip
...
RUN wget -O /DAC/.mujoco/mjkey.txt https://d1b10bmlvqabco.cloudfront.net/attach/k0cxuwlsoj36aw/j4h32wykj7b1l5/k2kzy5zutl61/mjkey.txt
#COPY ./mjkey.txt /DAC/.mujoco/mjkey.txt

ENV LD_LIBRARY_PATH /DAC/.mujoco/mjpro150/bin:${LD_LIBRARY_PATH}
ENV LD_LIBRARY_PATH /DAC/.mujoco/mjpro200_linux/bin:${LD_LIBRARY_PATH}
